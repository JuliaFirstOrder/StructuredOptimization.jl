...
prob = problem(expr)
@time sol = solve!(prob, RegLS.FPG(tol=1e-10,verbose=0,maxit=20000))
println(sol)
...
prob = problem(expr)
@time sol = solve!(prob, RegLS.PG(tol=1e-10,verbose=0))
println(sol)
...
prob = problem(expr)
@time sol = solve!(prob, RegLS.FPG(tol=1e-10,verbose=0))
println(sol)
...
@time sol = solve!(prob, RegLS.PG(tol=1e-8,verbose=0))
println(sol)
...
@time sol = solve!(prob, RegLS.FPG(tol=1e-8,verbose=0))
println(sol)
